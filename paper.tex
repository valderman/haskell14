...
client-server web applications using O'Caml. It accomplishes typed, seamless
communication by exposing mutable variables across the network. While this is a
quite flexible programming model, we believe that this uncontrolled, implicit
information flow makes programs harder to follow, debug, secure and optimize.
